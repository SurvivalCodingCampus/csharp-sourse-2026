...
public class MainClass
{
    ...
    public static void Main(string[] args)
    {
        ...
        Console.WriteLine("2011년에 일어난 모든 트랜잭션을 찾아 가격 기준 오름차순으로 정리하여 이름을 나열");
        ...
        Console.WriteLine("거래자가 근무하는 모든 도시를 중복 없이 나열");
        ...
        Console.WriteLine("전체 트랜잭션 중 최대값은 얼마인가?");
        Console.WriteLine(transactions.Max(e => e.Value));
        
        // 8. 전체 트랜잭션 중 최소값은 얼마인가?
        Console.WriteLine("전체 트랜잭션 중 최소값은 얼마인가?");
